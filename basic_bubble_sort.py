...
def plot(elements, sorterade_värde, total_tid):
    ...
    plt.subplot(1, 2, 2)
    plt.bar(range(len(sorterade_värde)), sorterade_värde, color='lightgreen')#rita ett stapel diagram för sorterade listan 
